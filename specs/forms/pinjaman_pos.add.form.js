// input.kreditpos_nosp
// input.kreditpos_anggota_id
// input.kreditpos_pinj_datetime
// input.kreditpos_fotoktp
// input.kreditpos_nopen
// input.kreditpos_nopen_col
// input.kreditpos_nopen_kprk
// input.kreditpos_noskpensiun
// input.kreditpos_instansi
// input.kreditpos_statussk
// input.kreditpos_pokok
// input.kreditpos_administrasi
// input.kreditpos_provisi
// input.kreditpos_tenor
// input.kreditpos_nojaminan
// input.kreditpos_jmlspm
// input.kreditpos_um
// input.kreditpos_simpwajib
// input.pkredit_id
// input.penjamin_nama
...
const pinjaman_pos_add_form = async function (kreditpos_nosp ,kreditpos_anggota_id ,kreditpos_jeniskredit_id ,kreditpos_wilpel_id ,kreditpos_pinj_datetime ,kreditpos_fotoktp ,kreditpos_nopen ,kreditpos_nopen_col ,kreditpos_nopen_kprk ,kreditpos_noskpensiun ,kreditpos_instansi ,kreditpos_statussk ,kreditpos_pokok ,kreditpos_bunga_id ,kreditpos_administrasi ,kreditpos_provisi ,kreditpos_tenor ,kreditpos_jaminan_id ,kreditpos_nojaminan ,kreditpos_jmlspm ,kreditpos_um ,kreditpos_akun_id ,kreditpos_simpwajib ,pkredit_id ,penjamin_nama ,penjamin_alamat ,penjamin_jk ,penjamin_notelp ,penjamin_pekerjaan ,penjamin_fotoktp ,penjamin_hubungan) {
...
export default pinjaman_pos_add_form;
