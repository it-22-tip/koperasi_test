const pegawai_add_form = async function (
  pegawai_wilpel_id,
  pegawai_nik,
  pegawai_anggota_id,
  pegawai_nama,
  ...
  await element(by.model('input.pegawai_nama')).sendKeys(pegawai_nama);
  await element(by.model('input.pegawai_lahir_date')).clear();
...
export default pegawai_add_form;
